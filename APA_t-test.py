...
sounds = ["APA-sub01", "APA-sub02", "APA-sub03", "APA-sub04", "APA-sub05", "APA-sub06", "APA-sub07", "APA-sub08", "APA-sub09", "APA-sub010",
          ...
          "APA-sub071", "APA-sub072", "APA-sub073", "APA-sub074", "APA-sub075"]

for i, sound in enumerate(sounds):
    mats = scipy.io.loadmat('E:/courses/IISC_working/P/P/APA/' + sound + '.mat')
...
plt.ylabel('p-value')
plt.title('Paired T-test p-values for Normalized Distances Across Sounds for APA')
plt.grid(True)
plt.legend()
plt.show()
