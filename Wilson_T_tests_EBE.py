...
all_distances_norm = []
sounds = ["EBE-sub01", "EBE-sub02", "EBE-sub03", "EBE-sub04", "EBE-sub05", "EBE-sub06", "EBE-sub07", "EBE-sub08", "EBE-sub09", "EBE-sub010",
          "EBE-sub011", "EBE-sub012", "EBE-sub013", "EBE-sub014", "EBE-sub015", "EBE-sub016", "EBE-sub017", "EBE-sub018", "EBE-sub019", "EBE-sub020",
          "EBE-sub021", "EBE-sub022", "EBE-sub023", "EBE-sub024", "EBE-sub025", "EBE-sub026", "EBE-sub027", "EBE-sub028", "EBE-sub029", "EBE-sub030",
          "EBE-sub031", "EBE-sub032", "EBE-sub033", "EBE-sub034", "EBE-sub035", "EBE-sub036", "EBE-sub037", "EBE-sub038", "EBE-sub039", "EBE-sub040",
          "EBE-sub042", "EBE-sub043", "EBE-sub044", "EBE-sub045", "EBE-sub046", "EBE-sub047", "EBE-sub048", "EBE-sub049", "EBE-sub050",
          "EBE-sub051", "EBE-sub052", "EBE-sub053", "EBE-sub054", "EBE-sub055", "EBE-sub056", "EBE-sub057", "EBE-sub058", "EBE-sub059", "EBE-sub060",
          "EBE-sub061", "EBE-sub062", "EBE-sub063", "EBE-sub064", "EBE-sub065", "EBE-sub066", "EBE-sub067", "EBE-sub068", "EBE-sub069", "EBE-sub070",
          "EBE-sub071", "EBE-sub072", "EBE-sub073", "EBE-sub074", "EBE-sub075"]

for i, sound in enumerate(sounds):
    mats = scipy.io.loadmat('E:/courses/IISC_working/EBE/EBE/' + sound + '.mat')
...
plt.title('Normalized Euclidean Distances Between Corresponding UL and LL Points Across All Sounds with Wilson Intervals(EBE)')
plt.grid(True)
plt.legend()
plt.show()
