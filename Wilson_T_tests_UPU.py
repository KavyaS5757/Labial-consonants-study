...
for i, sound in enumerate(sounds):
    mats = scipy.io.loadmat('E:/courses/IISC_working/UPU/UPU/' + sound + '.mat')
...
plt.title('Normalized Euclidean Distances Between Corresponding UL and LL Points Across All Sounds with Wilson Intervals(UPU)')
plt.grid(True)
plt.legend()
plt.show()
